...
// Supports both VITE_GEMINI_API_KEY (standard Vite) and the legacy define-mapped process.env.API_KEY
const getApiKey = (): string =>
  import.meta.env.VITE_GEMINI_API_KEY || (process.env.API_KEY as string) || '';
